...
local function tput(putt)
    ...
    local f = M.open(putt.host, putt.port, putt.create)
    f:greet()
...
M.put = socket.protect(function(putt, body)
...
local function tget(gett)
    ...
    local f = M.open(gett.host, gett.port, gett.create)
    f:greet()
...
M.command = socket.protect(function(cmdt)
    ...
    local f = M.open(cmdt.host, cmdt.port, cmdt.create)
    f:greet()
